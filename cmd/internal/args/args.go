...
type Arguments struct {
	InsecureTls                     bool            `json:"insecureTls,omitempty" jsonschema:"required=false,description=Ignore certificate errors when connecting to the Octopus server."`
	ExperimentalEnableStepTemplates bool            `json:"experimentalEnableStepTemplates,omitempty" jsonschema:"required=false,description=Has no effect. This option used to enable the export of step templates, but this is now a standard feature. This option is left in for compatibility."`
	Profiling                       bool            `json:"profiling,omitempty" jsonschema:"required=false,description=Enable profiling. Run 'pprof -http=:8080 octoterra.prof' to view the results."`
	ExcludeTerraformVariables       bool            `json:"excludeTerraformVariables,omitempty" jsonschema:"required=false,description=This option means the exported module does not expose Terraform variables for common inputs like the value of project or library variables set variables. This reduces the size of the Terraform configuration files, but makes the module less configurable because values are hard coded."`
	ExcludeSpaceCreation            bool            `json:"excludeSpaceCreation,omitempty" jsonschema:"required=false,description=This option excludes the Terraform configuration that is used to create the space."`
	ConfigFile                      string          `json:"configFile,omitempty" jsonschema:"required=false,description=The name of the configuration file to use. Do not include the extension. Defaults to octoterra"`
	ConfigPath                      string          `json:"configPath,omitempty" jsonschema:"required=false,description=The path of the configuration file to use. Defaults to the current directory"`
	Version                         bool            `json:"version,omitempty" jsonschema:"required=false,description=Print the version"`
	IgnoreInvalidExcludeExcept      bool            `json:"ignoreInvalidExcludeExcept,omitempty" jsonschema:"required=false,description=Ensures that resource names passed to the 'Exclude<ResourceType>Except' arguments are valid, and if they are not, removes those names from the list. This is useful when an external system attempts to filter results but places incorrect values into 'Exclude<ResourceType>Except' arguments. It may result in all resources being returned if no valid resources names are included in the 'Exclude<ResourceType>Except' arguments."`
	Url                             string          `json:"url,omitempty" jsonschema:"required=false,description=The Octopus URL e.g. https://myinstance.octopus.app - this is also defined in the OCTOPUS_CLI_SERVER environment variable. Do not set this when calling as an MCP tool."`
	ApiKey                          string          `json:"apiKey,omitempty" jsonschema:"required=false,description=The Octopus api key - this is also defined in the OCTOPUS_CLI_API_KEY environment variable. Do not set this when calling as an MCP tool."`
	AccessToken                     string          `json:"accessToken,omitempty" jsonschema:"required=false,description=The Octopus access token"`
	UseRedirector                   bool            `json:"useRedirector,omitempty" jsonschema:"required=false,description=Set to true to access the Octopus instance via the redirector"`
	RedirectorHost                  string          `json:"redirectorHost,omitempty" jsonschema:"required=false,description=The hostname of the redirector service"`
	RedirectorServiceApiKey         string          `json:"redirectorServiceApiKey,omitempty" jsonschema:"required=false,description=The service api key of the redirector service"`
	RedirecrtorApiKey               string          `json:"redirecrtorApiKey,omitempty" jsonschema:"required=false,description=The user api key of the redirector service"`
	RedirectorRedirections          string          `json:"redirectorRedirections,omitempty" jsonschema:"required=false,description=The redirection rules for the redirector service"`
	Space                           string          `json:"space,omitempty" jsonschema:"required=false,description=The Octopus space name or ID"`
	Destination                     string          `json:"dest,omitempty" jsonschema:"required=false,description=The directory to place the Terraform files in"`
	Console                         bool            `json:"console,omitempty" jsonschema:"required=false,description=Dump Terraform files to the console"`
	ProjectId                       StringSliceArgs `json:"projectId,omitempty" jsonschema:"required=false,description=Limit the export to a single project"`
	ProjectName                     StringSliceArgs `json:"projectName,omitempty" jsonschema:"required=false,description=Limit the export to a single project"`
	RunbookId                       string          `json:"runbookId,omitempty" jsonschema:"required=false,description=Limit the export to a single runbook. Runbooks are exported referencing external resources as data sources."`
	RunbookName                     string          `json:"runbookName,omitempty" jsonschema:"required=false,description=Limit the export to a single runbook. Requires projectName or projectId. Runbooks are exported referencing external resources as data sources."`
	LookupProjectDependencies       bool            `json:"lookupProjectDependencies,omitempty" jsonschema:"required=false,description=Use data sources to lookup the external project dependencies. Use this when the destination space has existing environments, accounts, tenants, feeds, git credentials, and library variable sets that this project should reference."`
	LookupProjectLinkTenants        bool            `json:"lookupProjectLinkTenants,omitempty" jsonschema:"required=false,description=When lookupProjectDependencies is true, lookupProjectLinkTenants will reestablish the link to tenants that were linked to the source project and recreate any project and common tenant variables. Essentially this means the exported project 'owns' the relationship to the tenant and any variables used by the tenant."`
	Stateless                       bool            `json:"stepTemplate,omitempty" jsonschema:"required=false,description=Create an Octopus step template"`
	StatelessAdditionalParams       StringSliceArgs `json:"stepTemplateAdditionalParameters,omitempty" jsonschema:"required=false,description=Indicates that a non-secret variable should be exposed as a parameter. The format of this option is 'ProjectName:VariableName'. This option is only used with the -stepTemplate option."`
	StepTemplateName                string          `json:"stepTemplateName,omitempty" jsonschema:"required=false,description=Step template name. Only used with the stepTemplate option."`
	StepTemplateKey                 string          `json:"stepTemplateKey,omitempty" jsonschema:"required=false,description=Step template key used when building parameter names. Only used with the stepTemplate option."`
	StepTemplateDescription         string          `json:"stepTemplateDescription,omitempty" jsonschema:"required=false,description=Step template description used when building parameter names. Only used with the stepTemplate option."`
	IgnoreCacManagedValues          bool            `json:"ignoreCacManagedValues,omitempty" jsonschema:"required=false,description=Pass this to exclude values managed by Config-as-Code from the exported Terraform. This includes non-sensitive variables, the deployment process, connectivity settings, and other project settings. This has no effect on projects that do not have CaC enabled."`
	ExcludeCaCProjectSettings       bool            `json:"excludeCaCProjectSettings,omitempty" jsonschema:"required=false,description=Pass this to exclude any Config-As-Code settings in the exported projects. Typically you set -ignoreCacManagedValues=false -excludeCaCProjectSettings=true to essentially 'convert' a CaC project to a regular project. Values from the 'main' or 'master' branches will be used first, or just fall back to the first configured branch."`
	BackendBlock                    string          `json:"terraformBackend,omitempty" jsonschema:"required=false,description=Specifies the backend type to be added to the exported Terraform configuration."`
	DetachProjectTemplates          bool            `json:"detachProjectTemplates,omitempty" jsonschema:"required=false,description=Detaches any step templates in the exported Terraform."`
	DefaultSecretVariableValues     bool            `json:"defaultSecretVariableValues,omitempty" jsonschema:"required=false,description=Pass this to set the default value of secret variables to the octostache template referencing the variable."`
	DummySecretVariableValues       bool            `json:"dummySecretVariableValues,omitempty" jsonschema:"required=false,description=Pass this to set the default value of secret variables, account secrets, feed credentials to a dummy value. This allows resources with secret values to be created without knowing the secrets, while still allowing the secret values to be specified if they are known. This option takes precedence over the defaultSecretVariableValues option."`
	InlineVariableValues            bool            `json:"inlineVariableValues,omitempty" jsonschema:"required=false,description=Inline the project and library variable set variable values rather than exposing their value as a Terraform variable. Secret variables will be inlined as dummy values. This option takes precedence over DummySecretVariableValues and DefaultSecretVariableValues."`
	ProviderVersion                 string          `json:"providerVersion,omitempty" jsonschema:"required=false,description=Specifies the Octopus Terraform provider version."`
	ExcludeProvider                 bool            `json:"excludeProvider,omitempty" jsonschema:"required=false,description=Exclude the provider from the exported Terraform configuration files. This is useful when you want to use a parent module to define the backend, as the parent module must define the provider."`
	IncludeProviderServerDetails    bool            `json:"includeProviderServerDetails,omitempty" jsonschema:"required=false,description=Define the server URL and API keys as variables passed to the provider. Set this to false to use the OCTOPUS_ACCESS_TOKEN, OCTOPUS_URL, and OCTOPUS_APIKEY environment variables to configure the provider."`
	IncludeOctopusOutputVars        bool            `json:"includeOctopusOutputVars,omitempty" jsonschema:"required=false,description=Capture the Octopus server URL, API key and Space ID as output variables. This is useful when querying the Terraform state file to locate where the resources were created."`
	LimitAttributeLength            int             `json:"limitAttributeLength,omitempty" jsonschema:"required=false,description=For internal use only. Limits the length of the attribute names."`
	LimitResourceCount              int             `json:"limitResourceCount,omitempty" jsonschema:"required=false,description=For internal use only. Limits the number of resources of a given type that are returned. For example, a value of 30 will ensure the exported Terraform only includes up to 30 accounts, and up to 30 feeds, and up to 30 projects etc. This is used to reduce the output when octoterra is used to generate a context for an LLM. This limit is a guide and it is possible that more than the specified number of resources are returned due to multiple goroutines adding resources to the output."`
	GenerateImportScripts           bool            `json:"generateImportScripts,omitempty" jsonschema:"required=false,description=Generate Bash and Powershell scripts used to import resources into the Terraform state."`
	IgnoreCacErrors                 bool            `json:"ignoreCacErrors,omitempty" jsonschema:"required=false,description=Ignores errors that would arise when a project can not resolve configuration in a Git repo."`

	OctopusManagedTerraformVars string `json:"octopusManagedTerraformVars,omitempty" jsonschema:"required=false,description=Specifies the name of an Octopus variable to be used as a template string in the body of the terraform.tfvars file. This allows Octopus to inject all the variables used by Terraform from a variable containing the contents of a terraform.tfvars file."`

	IgnoreProjectChanges         bool `json:"ignoreProjectChanges,omitempty" jsonschema:"required=false,description=Use the Terraform lifecycle meta-argument to ignore all changes to the project (including its variables) when exporting a single project."`
	IgnoreProjectVariableChanges bool `json:"ignoreProjectVariableChanges,omitempty" jsonschema:"required=false,description=Use the Terraform lifecycle meta-argument to ignore all changes to the project's variables when exporting a single project. This differs from the ignoreProjectChanges option by only ignoring changes to variables while reapplying changes to all other project settings."`
	IgnoreProjectGroupChanges    bool `json:"ignoreProjectGroupChanges,omitempty" jsonschema:"required=false,description=Use the Terraform lifecycle meta-argument to ignore the changes to the project's group."`
	IgnoreProjectNameChanges     bool `json:"ignoreProjectNameChanges,omitempty" jsonschema:"required=false,description=Use the Terraform lifecycle meta-argument to ignore the changes to the project's name."`
	LookUpDefaultWorkerPools     bool `json:"lookUpDefaultWorkerPools,omitempty" jsonschema:"required=false,description=Reference the worker pool by name when a step uses the default worker pool. This means exported projects do not inherit the default worker pool when they are applied in a new space."`
	IncludeIds                   bool `json:"includeIds,omitempty" jsonschema:"required=false,description=For internal use only. Include the 'id' field on generated resources. Note that this is almost always unnecessary and undesirable."`
	IncludeSpaceInPopulation     bool `json:"includeSpaceInPopulation,omitempty" jsonschema:"required=false,description=For internal use only. Include the space resource in the space population script. Note that this is almost always unnecessary and undesirable, as the space resources are included in the space creation module."`
	IncludeDefaultChannel        bool `json:"includeDefaultChannel,omitempty" jsonschema:"required=false,description=Internal use only. Includes the 'Default' channel as a standard channel resource rather than a data block."`
	...
	*/
	...
	ExcludeAllProjectVariables       bool            `json:"excludeAllProjectVariables,omitempty" jsonschema:"required=false,description=Exclude all project variables from being exported. WARNING: steps that used this variable may no longer function correctly."`
	ExcludeProjectVariables          StringSliceArgs `json:"excludeProjectVariable,omitempty" jsonschema:"required=false,description=Exclude a project variable from being exported. WARNING: steps that used this variable may no longer function correctly."`
	ExcludeProjectVariablesExcept    StringSliceArgs `json:"excludeProjectVariableExcept,omitempty" jsonschema:"required=false,description=All project variables except those defined with excludeProjectVariableExcept are excluded. WARNING: steps that used other variables may no longer function correctly."`
	ExcludeProjectVariablesRegex     StringSliceArgs `json:"excludeProjectVariableRegex,omitempty" jsonschema:"required=false,description=Exclude a project variable from being exported based on regex match. WARNING: steps that used this variable may no longer function correctly."`
	ExcludeVariableEnvironmentScopes StringSliceArgs `json:"excludeVariableEnvironmentScopes,omitempty" jsonschema:"required=false,description=Exclude an environment when it appears in a variable's environment scope. WARNING: variables scoped to this environment will no longer have that environment scope applied."`

	ExcludeAllTenantVariables    bool            `json:"excludeAllTenantVariables,omitempty" jsonschema:"required=false,description=Exclude all tenant variables from being exported. WARNING: steps that used this variable may no longer function correctly."`
	ExcludeTenantVariables       StringSliceArgs `json:"excludeTenantVariables,omitempty" jsonschema:"required=false,description=Exclude a tenant variable from being exported. WARNING: steps that used this variable may no longer function correctly."`
	ExcludeTenantVariablesExcept StringSliceArgs `json:"excludeTenantVariablesExcept,omitempty" jsonschema:"required=false,description=All tenant variables except those defined with excludeTenantVariablesExcept are excluded. WARNING: steps that used other variables may no longer function correctly."`
	ExcludeTenantVariablesRegex  StringSliceArgs `json:"excludeTenantVariablesRegex,omitempty" jsonschema:"required=false,description=Exclude a tenant variable from being exported based on regex match. WARNING: steps that used this variable may no longer function correctly."`

	ExcludeAllSteps    bool            `json:"excludeAllSteps,omitempty" jsonschema:"required=false,description=Exclude all steps when exporting projects or runbooks. WARNING: variables scoped to this step will no longer have the step scope applied."`
	ExcludeSteps       StringSliceArgs `json:"excludeSteps,omitempty" jsonschema:"required=false,description=A step to be excluded when exporting projects or runbooks. WARNING: variables scoped to this step will no longer have the step scope applied."`
	ExcludeStepsRegex  StringSliceArgs `json:"excludeStepsRegex,omitempty" jsonschema:"required=false,description=A step to be excluded when exporting projects or runbooks based on regex match. WARNING: variables scoped to this step will no longer have the step scope applied."`
	ExcludeStepsExcept StringSliceArgs `json:"excludeStepsExcept,omitempty" jsonschema:"required=false,description=All steps except those defined with excludeStepsExcept are excluded when exporting a project or runbook. WARNING: variables scoped to other steps will no longer have the step scope applied."`

	ExcludeAllChannels     bool            `json:"excludeAllChannels,omitempty" jsonschema:"required=false,description=Exclude all channels from being exported. WARNING: Variables and steps that were scoped to channels will become unscoped."`
	ExcludeChannels        StringSliceArgs `json:"excludeChannels,omitempty" jsonschema:"required=false,description=Exclude a channel from being exported. WARNING: Variables and steps that were scoped to channels will become unscoped."`
	ExcludeChannelsRegex   StringSliceArgs `json:"excludeChannelsRegex,omitempty" jsonschema:"required=false,description=Exclude a channel from being exported based on regex match. WARNING: Variables and steps that were scoped to channels will become unscoped."`
	ExcludeChannelsExcept  StringSliceArgs `json:"excludeChannelsExcept,omitempty" jsonschema:"required=false,description=All channels except those defined with excludeChannelsExcept are excluded. WARNING: Variables and steps that were scoped to channels will become unscoped."`
	ExcludeInvalidChannels bool            `json:"excludeInvalidChannels,omitempty" jsonschema:"required=false,description=Channels that reference packages that are no longer defined in the deployment process will be excluded. WARNING: Variables and steps that were scoped to channels will become unscoped."`

	ExcludeAllRunbooks    bool            `json:"excludeAllRunbooks,omitempty" jsonschema:"required=false,description=Exclude all runbooks when exporting a project or space. WARNING: variables scoped to this runbook will no longer have the runbook scope applied."`
	ExcludeRunbooks       StringSliceArgs `json:"excludeRunbook,omitempty" jsonschema:"required=false,description=A runbook to be excluded when exporting a single project. WARNING: variables scoped to this runbook will no longer have the runbook scope applied."`
	ExcludeRunbooksRegex  StringSliceArgs `json:"excludeRunbookRegex,omitempty" jsonschema:"required=false,description=A runbook to be excluded when exporting a single project based on regex match. WARNING: variables scoped to this runbook will no longer have the runbook scope applied."`
	ExcludeRunbooksExcept StringSliceArgs `json:"excludeRunbooksExcept,omitempty" jsonschema:"required=false,description=All runbooks except those defined with excludeRunbooksExcept are excluded when exporting a single project. WARNING: variables scoped to other runbooks will no longer have the runbook scope applied."`

	ExcludeAllTriggers    bool            `json:"excludeAllTriggers,omitempty" jsonschema:"required=false,description=Exclude all triggers when exporting a project or space."`
	ExcludeTriggers       StringSliceArgs `json:"excludeTrigger,omitempty" jsonschema:"required=false,description=A trigger to be excluded when exporting a single project."`
	ExcludeTriggersRegex  StringSliceArgs `json:"excludeTriggerRegex,omitempty" jsonschema:"required=false,description=A trigger to be excluded when exporting a single project based on regex match."`
	ExcludeTriggersExcept StringSliceArgs `json:"excludeTriggersExcept,omitempty" jsonschema:"required=false,description=All triggers except those defined with excludeTriggersExcept are excluded when exporting a single project."`

	ExcludeLibraryVariableSets       StringSliceArgs `json:"excludeLibraryVariableSet,omitempty" jsonschema:"required=false,description=A library variable set to be excluded when exporting a single project. WARNING: projects that linked this library variable set will no longer include these variables."`
	ExcludeLibraryVariableSetsRegex  StringSliceArgs `json:"excludeLibraryVariableSetRegex,omitempty" jsonschema:"required=false,description=A library variable set to be excluded when exporting a single project based on regex match. WARNING: projects that linked this library variable set will no longer include these variables."`
	ExcludeLibraryVariableSetsExcept StringSliceArgs `json:"excludeLibraryVariableSetsExcept,omitempty" jsonschema:"required=false,description=All library variable sets except those defined with excludeLibraryVariableSetsExcept are excluded. WARNING: projects that linked other library variable sets will no longer include these variables."`
	ExcludeAllLibraryVariableSets    bool            `json:"excludeAllLibraryVariableSets,omitempty" jsonschema:"required=false,description=Exclude all library variable sets. WARNING: projects that linked this library variable set will no longer include these variables."`

	ExcludeEnvironments       StringSliceArgs `json:"excludeEnvironments,omitempty" jsonschema:"required=false,description=An environment to be excluded when exporting a single project. WARNING: this can have unexpected side effects, such as variables becoming unscoped. The exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeEnvironmentsRegex  StringSliceArgs `json:"excludeEnvironmentsRegex,omitempty" jsonschema:"required=false,description=An environment to be excluded when exporting a single project based on regex match. WARNING: this can have unexpected side effects, such as variables becoming unscoped. The exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeEnvironmentsExcept StringSliceArgs `json:"excludeEnvironmentsExcept,omitempty" jsonschema:"required=false,description=All environments except those defined with excludeEnvironmentsExcept are excluded. WARNING: this can have unexpected side effects, such as variables becoming unscoped. The exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllEnvironments    bool            `json:"excludeAllEnvironments,omitempty" jsonschema:"required=false,description=Exclude all environments. WARNING: this can have unexpected side effects, such as variables becoming unscoped. The exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeFeeds       StringSliceArgs `json:"excludeFeeds,omitempty" jsonschema:"required=false,description=A feed to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeFeedsRegex  StringSliceArgs `json:"excludeFeedsRegex,omitempty" jsonschema:"required=false,description=A feed to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeFeedsExcept StringSliceArgs `json:"excludeFeedsExcept,omitempty" jsonschema:"required=false,description=All feeds except those defined with excludeFeedsExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllFeeds    bool            `json:"excludeAllFeeds,omitempty" jsonschema:"required=false,description=Exclude all feeds. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeProjectGroups       StringSliceArgs `json:"excludeProjectGroups,omitempty" jsonschema:"required=false,description=A project group to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeProjectGroupsRegex  StringSliceArgs `json:"excludeProjectGroupsRegex,omitempty" jsonschema:"required=false,description=A project group to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeProjectGroupsExcept StringSliceArgs `json:"excludeProjectGroupsExcept,omitempty" jsonschema:"required=false,description=All project groups except those defined with excludeProjectGroupsExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllProjectGroups    bool            `json:"excludeAllProjectGroups,omitempty" jsonschema:"required=false,description=Exclude all project groups. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeAccounts       StringSliceArgs `json:"excludeAccounts,omitempty" jsonschema:"required=false,description=An account to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAccountsRegex  StringSliceArgs `json:"excludeAccountsRegex,omitempty" jsonschema:"required=false,description=An account to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAccountsExcept StringSliceArgs `json:"excludeAccountsExcept,omitempty" jsonschema:"required=false,description=All accounts except those defined with excludeAccountsExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllAccounts    bool            `json:"excludeAllAccounts,omitempty" jsonschema:"required=false,description=Exclude all accounts. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeCertificates       StringSliceArgs `json:"excludeCertificates,omitempty" jsonschema:"required=false,description=A certificate to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeCertificatesRegex  StringSliceArgs `json:"excludeCertificatesRegex,omitempty" jsonschema:"required=false,description=A certificate to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeCertificatesExcept StringSliceArgs `json:"excludeCertificatesExcept,omitempty" jsonschema:"required=false,description=All certificates except those defined with excludeCertificatesExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllCertificates    bool            `json:"excludeAllCertificates,omitempty" jsonschema:"required=false,description=Exclude all certificates. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeLifecycles       StringSliceArgs `json:"excludeLifecycles,omitempty" jsonschema:"required=false,description=A lifecycle to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeLifecyclesRegex  StringSliceArgs `json:"excludeLifecyclesRegex,omitempty" jsonschema:"required=false,description=A lifecycle to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeLifecyclesExcept StringSliceArgs `json:"excludeLifecyclesExcept,omitempty" jsonschema:"required=false,description=All lifecycles except those defined with excludeLifecyclesExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllLifecycles    bool            `json:"excludeAllLifecycles,omitempty" jsonschema:"required=false,description=Exclude all lifecycles. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeWorkerpools       StringSliceArgs `json:"excludeWorkerPools,omitempty" jsonschema:"required=false,description=A worker pool to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeWorkerpoolsRegex  StringSliceArgs `json:"excludeWorkerPoolsRegex,omitempty" jsonschema:"required=false,description=A worker pool to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeWorkerpoolsExcept StringSliceArgs `json:"excludeWorkerPoolsExcept,omitempty" jsonschema:"required=false,description=All worker pools except those defined with excludeWorkerPoolsExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllWorkerpools    bool            `json:"excludeAllWorkerPools,omitempty" jsonschema:"required=false,description=Exclude all worker pools. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeMachinePolicies       StringSliceArgs `json:"excludeMachinePolicies,omitempty" jsonschema:"required=false,description=A machine policy to be excluded when exporting a single project. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeMachinePoliciesRegex  StringSliceArgs `json:"excludeMachinePoliciesRegex,omitempty" jsonschema:"required=false,description=A machine policy to be excluded when exporting a single project based on regex match. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeMachinePoliciesExcept StringSliceArgs `json:"excludeMachinePoliciesExcept,omitempty" jsonschema:"required=false,description=All machine policies except those defined with excludeMachinePoliciesExcept are excluded. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`
	ExcludeAllMachinePolicies    bool            `json:"excludeAllMachinePolicies,omitempty" jsonschema:"required=false,description=Exclude all machine policies. WARNING: the exported module is unlikely to be complete and will fail to apply if this option is enabled."`

	ExcludeMachineProxies       StringSliceArgs `json:"excludeMachineProxies,omitempty" jsonschema:"required=false,description=A machine proxy to be excluded when exporting a single project."`
	ExcludeMachineProxiesRegex  StringSliceArgs `json:"excludeMachineProxiesRegex,omitempty" jsonschema:"required=false,description=A machine proxy to be excluded when exporting a single project based on regex match."`
	ExcludeMachineProxiesExcept StringSliceArgs `json:"excludeMachineProxiesExcept,omitempty" jsonschema:"required=false,description=All machine proxies except those defined with excludeMachineProxiesExcept are excluded."`
	ExcludeAllMachineProxies    bool            `json:"excludeAllMachineProxies,omitempty" jsonschema:"required=false,description=Exclude all machine proxies."`

	ExcludeTenantTags StringSliceArgs `json:"excludeTenantTags,omitempty" jsonschema:"required=false,description=Exclude an individual tenant tag from being exported. Tags are in the format 'taggroup/tagname'. WARNING: Steps that were set to run on tenants with excluded tags will no longer have that condition applied."`

	ExcludeTenantTagSets       StringSliceArgs `json:"excludeTenantTagSets,omitempty" jsonschema:"required=false,description=Exclude a tenant tag set from being exported. WARNING: Steps that were set to run on tenants with excluded tags will no longer have that condition applied."`
	ExcludeTenantTagSetsRegex  StringSliceArgs `json:"excludeTenantTagSetsRegex,omitempty" jsonschema:"required=false,description=Exclude tenant tag sets from being exported based on a regex. WARNING: Resources scoped to tenant tag sets will be unscoped."`
	ExcludeTenantTagSetsExcept StringSliceArgs `json:"excludeTenantTagSetsExcept,omitempty" jsonschema:"required=false,description=Exclude all tenant tag sets except for those defined in this list. WARNING: Resources scoped to tenant tag sets will be unscoped."`
	ExcludeAllTenantTagSets    bool            `json:"excludeAllTenantTagSets,omitempty" jsonschema:"required=false,description=Exclude all tenant tag sets from being exported. WARNING: Resources scoped to tenant tag sets will be unscoped."`

	ExcludeTenants         StringSliceArgs `json:"excludeTenants,omitempty" jsonschema:"required=false,description=Exclude a tenant from being exported."`
	ExcludeTenantsRegex    StringSliceArgs `json:"excludeTenantsRegex,omitempty" jsonschema:"required=false,description=Exclude a tenant from being exported based on a regex."`
	ExcludeTenantsWithTags StringSliceArgs `json:"excludeTenantsWithTag,omitempty" jsonschema:"required=false,description=Exclude any tenant with this tag from being exported. This is useful when using tags to separate tenants that can be exported with those that should not. Tags are in the format TagGroupName/TagName."`
	ExcludeTenantsExcept   StringSliceArgs `json:"excludeTenantsExcept,omitempty" jsonschema:"required=false,description=Exclude all tenants except for those defined in this list. The tenants in excludeTenants take precedence, so a tenant defined here and in excludeTenants is excluded."`
	ExcludeAllTenants      bool            `json:"excludeAllTenants,omitempty" jsonschema:"required=false,description=Exclude all tenants from being exported."`

	ExcludeProjects       StringSliceArgs `json:"excludeProjects,omitempty" jsonschema:"required=false,description=Exclude a project from being exported. This is only used when exporting a space."`
	ExcludeProjectsExcept StringSliceArgs `json:"excludeProjectsExcept,omitempty" jsonschema:"required=false,description=All projects except those defined with excludeProjectsExcept are excluded. This is only used when exporting a space."`
	ExcludeProjectsRegex  StringSliceArgs `json:"excludeProjectsRegex,omitempty" jsonschema:"required=false,description=Exclude a project from being exported based on regex match. This is only used when exporting a space."`
	ExcludeAllProjects    bool            `json:"excludeAllProjects,omitempty" jsonschema:"required=false,description=Exclude all projects from being exported. This is only used when exporting a space."`

	ExcludeAllTargets                bool            `json:"excludeAllTargets,omitempty" jsonschema:"required=false,description=Exclude all targets from being exported. WARNING: Variables that were scoped to targets will become unscoped."`
	ExcludeTargets                   StringSliceArgs `json:"excludeTargets,omitempty" jsonschema:"required=false,description=Exclude targets from being exported. WARNING: Variables that were scoped to targets will become unscoped."`
	ExcludeTargetsRegex              StringSliceArgs `json:"excludeTargetsRegex,omitempty" jsonschema:"required=false,description=Exclude targets from being exported based on a regex. WARNING: Variables that were scoped to targets will become unscoped."`
	ExcludeTargetsExcept             StringSliceArgs `json:"excludeTargetsExcept,omitempty" jsonschema:"required=false,description=Exclude all targets except for those defined in this list. The targets in excludeTargets take precedence, so a target defined here and in excludeTargets is excluded. WARNING: Variables that were scoped to other targets will become unscoped."`
	ExcludeTargetsWithNoEnvironments bool            `json:"excludeTargetsWithNoEnvironments,omitempty" jsonschema:"required=false,description=Exclude targets that have had all their environments excluded. WARNING: Variables that were scoped to targets will become unscoped."`

	ExcludeAllWorkers    bool            `json:"excludeAllWorkers,omitempty" jsonschema:"required=false,description=Exclude all workers from being exported."`
	ExcludeWorkers       StringSliceArgs `json:"excludeWorkers,omitempty" jsonschema:"required=false,description=Exclude workers from being exported."`
	ExcludeWorkersRegex  StringSliceArgs `json:"excludeWorkersRegex,omitempty" jsonschema:"required=false,description=Exclude workers from being exported based on a regex."`
	ExcludeWorkersExcept StringSliceArgs `json:"excludeWorkersExcept,omitempty" jsonschema:"required=false,description=Exclude all workers except for those defined in this list. The targets in excludeWorkers take precedence, so a worker defined here and in excludeWorkers is excluded."`

	ExcludeAllGitCredentials bool `json:"excludeAllGitCredentials,omitempty" jsonschema:"required=false,description=Exclude all git credentials. Must be used with -excludeCaCProjectSettings."`

	ExcludeAllDeploymentFreezes    bool            `json:"excludeAllDeploymentFreezes,omitempty" jsonschema:"required=false,description=Exclude all deployment freezes from being exported."`
	ExcludeDeploymentFreezes       StringSliceArgs `json:"excludeDeploymentFreezes,omitempty" jsonschema:"required=false,description=Exclude a deployment freeze from being exported."`
	ExcludeDeploymentFreezesExcept StringSliceArgs `json:"excludeDeploymentFreezesExcept,omitempty" jsonschema:"required=false,description=All deployment freezes except those defined with excludeDeploymentFreezesExcept are excluded."`
	ExcludeDeploymentFreezesRegex  StringSliceArgs `json:"excludeDeploymentFreezesRegex,omitempty" jsonschema:"required=false,description=Exclude a deployment freeze from being exported based on regex match."`

	ExcludePlatformHubVersionControl bool `json:"excludePlatformHubVersionControl,omitempty" jsonschema:"required=false,description=Exclude the Platform Hub version control settings."`
}
