...
func ParseArgs(args []string) (Arguments, string, error) {
	...
	flags.BoolVar(&arguments.ExperimentalEnableStepTemplates, "experimentalEnableStepTemplates", false, "Enable the export of step templates. This is an experimental feature. The Terraform generated by this feature will be replaced in future with resources that are incompatible with those generated today.")
