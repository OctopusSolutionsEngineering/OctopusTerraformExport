...
func ParseArgs(args []string) (Arguments, string, error) {
	...
	flags.BoolVar(&arguments.ExcludeOutputVariables, "excludeOutputVariables", false, "This option excludes the generation of output variables for space name and ID.")
