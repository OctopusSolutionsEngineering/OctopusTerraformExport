...
func ParseArgs(args []string) (Arguments, string, error) {
	...
	flags.BoolVar(&arguments.ExperimentalEnableStepTemplates, "experimentalEnableStepTemplates", false, "Enable the export of step templates. Enabling this feature disables -detachProjectTemplates. This is an experimental feature. The Terraform generated by this feature will be replaced in future with resources that are incompatible with those generated today.")
	...
	flags.BoolVar(&arguments.GenerateImportBlocks, "generateImportBlocks", false, "Add import blocks to the generated Terraform. This is useful when you want to export resources and then immediately import them, effectively having Terraform take ownership of existing Octopus resources.")
