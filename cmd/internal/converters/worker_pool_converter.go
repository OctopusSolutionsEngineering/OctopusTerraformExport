...
func (c WorkerPoolConverter) toHcl(pool octopus2.WorkerPool, _ bool, lookup bool, stateless bool, dependencies *data.ResourceDetailsCollection) error {
...
func (c WorkerPoolConverter) createDynamicWorkerPoolLookupResource(resourceName string, thisResource *data.ResourceDetails, pool octopus2.WorkerPool) {
...
func (c WorkerPoolConverter) createDynamicWorkerPoolResource(resourceName string, thisResource *data.ResourceDetails, pool octopus2.WorkerPool, stateless bool) {
	if stateless {
...
func (c WorkerPoolConverter) createStaticWorkerPoolResource(resourceName string, thisResource *data.ResourceDetails, pool octopus2.WorkerPool, stateless bool) {
	if stateless {
		thisResource.Lookup = "${length(data." + octopusdeployWorkerPoolsDataType + "." + resourceName + ".worker_pools) != 0 " +
			"? data." + octopusdeployWorkerPoolsDataType + "." + resourceName + ".worker_pools[0].id " +
...
func (c WorkerPoolConverter) createStaticWorkerPoolLookupResource(resourceName string, thisResource *data.ResourceDetails, pool octopus2.WorkerPool) {
	thisResource.Lookup = "${data." + octopusdeployWorkerPoolsDataType + "." + resourceName + ".worker_pools[0].id}"
