...
// https://registry.terraform.io/providers/OctopusDeploy/octopusdeploy/latest/docs/resources/process_templated_child_step
type TerraformProcessTemplatedChildStep struct {
...
func (a *TerraformProcessTemplatedChildStep) SetWorkerPoolId(workerPool string) {
