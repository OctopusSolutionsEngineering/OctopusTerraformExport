	...
	exportImportAndTest(
		...
		func(url string, space string, apiKey string, dest string) error {
			args := args2.Arguments{
				...
				Stateless:                        arguments.Stateless,
				StepTemplateName:                 arguments.StepTemplateName,
				StepTemplateKey:                  arguments.StepTemplateKey,
			}
...
func TestSpaceExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/01-singlespace/space_creation",
		"../test/terraform/01-singlespace/space_population",
		[]string{},
		[]string{},
		args2.Arguments{},
...
func TestProjectGroupExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/02-projectgroup/space_creation",
		"../test/terraform/02-projectgroup/space_population",
		[]string{},
		[]string{},
		args2.Arguments{
...
func TestAwsAccountExport(t *testing.T) {
	exportSpaceImportAndTest(t,
		"../test/terraform/03-awsaccount/space_creation",
		"../test/terraform/03-awsaccount/space_population",
		[]string{},
...
func TestAzureAccountExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/04-azureaccount/space_creation",
		"../test/terraform/04-azureaccount/space_population",
		[]string{},
...
func TestUsernamePasswordAccountExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/05-userpassaccount/space_creation",
		"../test/terraform/05-userpassaccount/space_population",
		[]string{},
...
func TestGcpAccountExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/06-gcpaccount/space_creation",
		"../test/terraform/06-gcpaccount/space_population",
		[]string{},
...
func TestSshAccountExport(t *testing.T) {
	...
	exportSpaceImportAndTest(
		t,
		"../test/terraform/07-sshaccount/space_creation",
		"../test/terraform/07-sshaccount/space_population",
		[]string{},
		[]string{
...
func TestAzureSubscriptionAccountExport(t *testing.T) {
	exportSpaceImportAndTest(t,
		"../test/terraform/08-azuresubscriptionaccount/space_creation",
		"../test/terraform/08-azuresubscriptionaccount/space_population",
		[]string{},
		[]string{
...
func TestTokenAccountExport(t *testing.T) {
	exportSpaceImportAndTest(
		t,
		"../test/terraform/09-tokenaccount/space_creation",
		"../test/terraform/09-tokenaccount/space_population",
		[]string{},
		[]string{
		...
		func(t *testing.T, container *test.OctopusContainer, recreatedSpaceId string, terraformStateDir string) error {
			...
			for _, v := range collection.Items {
				if v.Name == resourceName {
					...
					if len(secondVar[0].Scope.Role) != 1 {
						return errors.New("The library variable set variable \"Test.SecretVariable\" must have one machine tag scope")
					}

					if len(secondVar[0].Scope.Role) != 1 || secondVar[0].Scope.Role[0] != "test" {
						return errors.New("The library variable set variable \"Test.SecretVariable\" must have machine tag scope of \"test\" ( was \"" + secondVar[0].Scope.Role[0] + "\")")
					}

					if len(secondVar[0].Scope.Machine) != 1 {
						return errors.New("The library variable set variable \"Test.SecretVariable\" must have one machine scope")
					}

					if len(secondVar[0].Scope.Environment) != 3 {
						return errors.New("The library variable set variable \"Test.SecretVariable\" must be scoped to 3 environments")
					}
	...
	exportProjectLookupImportAndTest(
		...
		func(t *testing.T, container *test.OctopusContainer, recreatedSpaceId string, terraformStateDir string) error {
			...
			err := func() error {
				...
				if len(scopedVar[0].Scope.Machine) != 8 {
					...
					return errors.New("The project must have 1 variable called \"test\" scoped to eight machines " +
...
// TestGitDependenciesExport verifies that a project can be reimported with steps that have git dependencies
func TestGitDependenciesSingleProjectExport(t *testing.T) {
	exportProjectImportAndTest(
		t,
		"Test",
		"../test/terraform/74-gitdependencies/space_creation",
...
// The tests are run twice, once as a regular export and once as a stateless export.
//
//	./octoterra \
...
func TestEverything(t *testing.T) {
	...
	for _, arg := range arguments {
		t.Run(fmt.Sprintf("Stateless: %t", arg.Stateless), func(t *testing.T) {
			exportSpaceImportAndTest(
				t,
